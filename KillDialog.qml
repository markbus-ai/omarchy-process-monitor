...
Rectangle {
  ...
  MouseArea { anchors.fill: parent; onClicked: dlg.cancelled() }
    ...
    Rectangle {
      anchors.centerIn: parent; width: 280; height: dlg.errText !== "" ? 196 : 178; radius: 12
      ...
      Rectangle {
        x: 20; y: dlg.errText !== "" ? 78 : 62; width: 115; height: 38; radius: 7
      ...
      Rectangle {
        x: 145; y: dlg.errText !== "" ? 78 : 62; width: 115; height: 38; radius: 7
      ...
      Rectangle {
        x: 110; y: dlg.errText !== "" ? 128 : 112; width: 60; height: 24; radius: 5
